...
*/
	...
	static int yearMin=20,yearMax=21;
	static int balanceTime=10;
	static int fixtureOffsetMin=10,fixtureOffsetMax=-10;
	...
	//printRatingsReport();
//	printFixtures(1);
			printFixtures(1,Common.getDate()); 
	printFixtures(2,Common.getDate());
...
//			File csvOutputFile = new File("test101");
//	try (PrintWriter writer = new PrintWriter(new File("/home/makis/Desktop/output.csv"))) {
			try (PrintWriter writer = new PrintWriter(new File("test.csv"))) {
				System.out.println(archives.size());
			      StringBuilder sb = new StringBuilder();
			      sb.append("date"+","+"homeTeam"+","+"awayTeam"
			    			+","+"ratingWin"+","+"ratingOver"
			    		  //+","+"ratingBtts"+","+"ratingCorners"
			    		//	+","+"matchesHome"+","+"matchesA"+","+"matchesAway"+","+"matchesB"
			    			+","+"goalsScoHomeAvg"+","+"goalsScoAvgA"+","+"goalsScoAwayAvg"+","+"goalsScoAvgB"
			    			+","+"goalsConHomeAvg"+","+"goalsConAvgA"+","+"goalsConAwayAvg"+","+"goalsConAvgB"
			    			+","+"wonHomePer"+","+"wonPerA"+","+"wonAwayPer"+","+"wonPerB"
			    			+","+"bttsHomePer"+","+"bttsPerA"+","+"bttsAwayPer"+","+"bttsPerB"
			    			+","+"overHomePer"+","+"overPerA"+","+"overAwayPer"+","+"overPerB"
			    			+","+"bOverHomePer"+","+"bOverPerA"+","+"bOverAwayPer"+","+"bOverPerB"+"\n");
			    	  for(int i=0; i < archives.size();i++) {
			    	  sb.append(archives.get(i).createCsvLine()+"\n");
			      }			      
	...
	public void storeArchives() {
			...
			if (competitions.get(i).fixtures != null && (competitions.get(i).year == Common.getSeason()-1 || competitions.get(i).year == Common.getSeason()))
				if (competitions.get(i).fixtures.size() > 0) {
					archives.addAll(competitions.get(i).archives);
					}
		}
