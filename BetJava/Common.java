...
public class Common {
	...
	public static String pathToSrc = "/home/makis/Projects/Analysis/",
			pathToNewData = pathToSrc+"NewData/",
			pathToOldData = pathToSrc+"OldData/",
...
pathToOutput = "/home/makis/Desktop/output."+Common.getDate().replace("/","")+".txt";
	...
	public static String[] abrOptExtra= 
								...
								/*25*/"BbAv<2.5"}, //Betbrain average under 2.5 goals
									...
									{/*0*/"Country",
										...
										/*5*/"AvgA",
										/*6*/"AvgD",
										/*7*/"Avg>2.5", //Betbrain average over 2.5 goals
										/*8*/"Avg<2.5"}, //Betbrain average under 2.5 goals
...
seasonsNewInput  = {"2021/"},
seasonsNewOutput = {".2021"},
				
seasonsOldInput  = {"0001/","0102/","0203/","0304/","0405/","0506/","0607/","0708/","0809/","0910/","1011/","1112/","1213/","1314/","1415/","1516/","1617/","1718/","1819/","1920/"},
seasonsOldOutput = {".0001",".0102",".0203",".0304",".0405",".0506",".0607",".0708",".0809",".0910",".1011",".1112",".1213",".1314",".1415",".1516",".1617",".1718",".1819",".1920"},
	...
	public static String fixTime(String inputTime) {
		...
		String input=getDate()+" "+inputTime+" +0000";
	...
	public static String fixYear(String inputDate) {
		String output="";
		...
		try {
			...
			output=inputDate;
			System.out.println("Alert:Error Date "+inputDate);
			} 
		return output;
	}
