	...
	public void createFixtures(){
		if(fixtures!=null)
			if(fixtures.size()>0) {
				for(int i=0;i<fixtures.size();i++){
					for(int j=0;j<teams.size();j++){
						if (fixtures.get(i).homeTeam.equals(teams.get(j).name)) {
							...
							fixtures.get(i).matchesHome=teams.get(j).stats.matchesHome;
							fixtures.get(i).matchesA=teams.get(j).stats.matches;
							
							fixtures.get(i).goalsScoHomeAvg=teams.get(j).stats.goalsScoHomeAvg;
							fixtures.get(i).goalsScoAvgA=teams.get(j).stats.goalsScoAvg;
							
							fixtures.get(i).goalsConHomeAvg=teams.get(j).stats.goalsConHomeAvg;
							fixtures.get(i).goalsConAvgA=teams.get(j).stats.goalsConAvg;
							
							fixtures.get(i).wonHomePer=teams.get(j).stats.wonHomePer;
							fixtures.get(i).wonPerA=teams.get(j).stats.wonPer;
							
							fixtures.get(i).bttsHomePer=teams.get(j).stats.bttsHomePer;
							fixtures.get(i).bttsPerA=teams.get(j).stats.bttsPer;
							
							fixtures.get(i).overHomePer=teams.get(j).stats.overHomePer;
							fixtures.get(i).overPerA=teams.get(j).stats.overPer;
							
							fixtures.get(i).bOverHomePer=teams.get(j).stats.bOverHomePer;
							fixtures.get(i).bOverPerA=teams.get(j).stats.bOverPer;
							
							fixtures.get(i).cornersWonHomeAvg=teams.get(j).stats.cornersWonHomeAvg;
							fixtures.get(i).cornersWonAvgA=teams.get(j).stats.cornersWonAvg;
							
							fixtures.get(i).shotsWonHomeAvg=teams.get(j).stats.shotsWonHomeAvg;
							fixtures.get(i).shotsWonAvgA=teams.get(j).stats.shotsWonAvg;
							
							fixtures.get(i).shotsOnTargetWonHomeAvg=teams.get(j).stats.shotsOnTargetWonHomeAvg;
							fixtures.get(i).shotsOnTargetWonAvgA=teams.get(j).stats.shotsOnTargetWonAvg;
							
							fixtures.get(i).foulsWonHomeAvg=teams.get(j).stats.foulsWonHomeAvg;
							fixtures.get(i).foulsWonAvgA=teams.get(j).stats.foulsWonAvg;
							
							fixtures.get(i).yellowsWonHomeAvg=teams.get(j).stats.yellowsWonHomeAvg;
							fixtures.get(i).yellowsWonAvgA=teams.get(j).stats.yellowsWonAvg;
							
							fixtures.get(i).cornersConHomeAvg=teams.get(j).stats.cornersConHomeAvg;
							fixtures.get(i).cornersConAvgA=teams.get(j).stats.cornersConAvg;
							
							fixtures.get(i).shotsConHomeAvg=teams.get(j).stats.shotsConHomeAvg;
							fixtures.get(i).shotsConAvgA=teams.get(j).stats.shotsConAvg;
							
							fixtures.get(i).shotsOnTargetConHomeAvg=teams.get(j).stats.shotsOnTargetConHomeAvg;
							fixtures.get(i).shotsOnTargetConAvgA=teams.get(j).stats.shotsOnTargetConAvg;
							
							fixtures.get(i).foulsConHomeAvg=teams.get(j).stats.foulsConHomeAvg;
							fixtures.get(i).foulsConAvgA=teams.get(j).stats.foulsConAvg;
							
							fixtures.get(i).yellowsConHomeAvg=teams.get(j).stats.yellowsConHomeAvg;
							fixtures.get(i).yellowsConAvgA=teams.get(j).stats.yellowsConAvg;
							
							fixtures.get(i).redsConHomeAvg=teams.get(j).stats.redsConHomeAvg;
							fixtures.get(i).redsConAvgA=teams.get(j).stats.redsConAvg;
							
							fixtures.get(i).form3PointsHome=teams.get(j).stats.form3PointsHome;
							fixtures.get(i).form5PointsA=teams.get(j).stats.form5Points;
							
							fixtures.get(i).form3GoalsScoHome=teams.get(j).stats.form3GoalsScoHome;
							fixtures.get(i).form5GoalsScoA=teams.get(j).stats.form5GoalsSco;
							
							fixtures.get(i).form3GoalsConHome=teams.get(j).stats.form3GoalsConHome;
							fixtures.get(i).form5GoalsConA=teams.get(j).stats.form5GoalsCon;
							
							fixtures.get(i).form3BttsHome=teams.get(j).stats.form3BttsHome;
							fixtures.get(i).form5BttsA=teams.get(j).stats.form5Btts;
							
							fixtures.get(i).form3OverHome=teams.get(j).stats.form3OverHome;
							fixtures.get(i).form5OverA=teams.get(j).stats.form5Over;
							
							fixtures.get(i).matchesFormHome=teams.get(j).stats.matchesFormHome;
							fixtures.get(i).matchesFormA=teams.get(j).stats.matchesForm;
							}
						...
						if (fixtures.get(i).awayTeam.equals(teams.get(j).name)) {
							...
							fixtures.get(i).matchesAway=teams.get(j).stats.matchesAway;
							fixtures.get(i).matchesB=teams.get(j).stats.matches;
							
							fixtures.get(i).goalsScoAwayAvg=teams.get(j).stats.goalsScoAwayAvg;
							fixtures.get(i).goalsScoAvgB=teams.get(j).stats.goalsScoAvg;
							
							fixtures.get(i).goalsConAwayAvg=teams.get(j).stats.goalsConAwayAvg;
							fixtures.get(i).goalsConAvgB=teams.get(j).stats.goalsConAvg;
							
							fixtures.get(i).wonAwayPer=teams.get(j).stats.wonAwayPer;
							fixtures.get(i).wonPerB=teams.get(j).stats.wonPer;
							
							fixtures.get(i).bttsAwayPer=teams.get(j).stats.bttsAwayPer;
							fixtures.get(i).bttsPerB=teams.get(j).stats.bttsPer;
							
							fixtures.get(i).overAwayPer=teams.get(j).stats.overAwayPer;
							fixtures.get(i).overPerB=teams.get(j).stats.overPer;
							
							fixtures.get(i).bOverAwayPer=teams.get(j).stats.bOverAwayPer;
							fixtures.get(i).bOverPerB=teams.get(j).stats.bOverPer;
							
							
							
							fixtures.get(i).cornersWonAwayAvg=teams.get(j).stats.cornersWonAwayAvg;
							fixtures.get(i).cornersWonAvgB=teams.get(j).stats.cornersWonAvg;
							
							fixtures.get(i).shotsWonAwayAvg=teams.get(j).stats.shotsWonAwayAvg;
							fixtures.get(i).shotsWonAvgB=teams.get(j).stats.shotsWonAvg;
							
							fixtures.get(i).shotsOnTargetWonAwayAvg=teams.get(j).stats.shotsOnTargetWonAwayAvg;
							fixtures.get(i).shotsOnTargetWonAvgB=teams.get(j).stats.shotsOnTargetWonAvg;
							
							fixtures.get(i).foulsWonAwayAvg=teams.get(j).stats.foulsWonAwayAvg;
							fixtures.get(i).foulsWonAvgB=teams.get(j).stats.foulsWonAvg;
							
							fixtures.get(i).yellowsWonAwayAvg=teams.get(j).stats.yellowsWonAwayAvg;
							fixtures.get(i).yellowsWonAvgB=teams.get(j).stats.yellowsWonAvg;
							
							fixtures.get(i).cornersConAwayAvg=teams.get(j).stats.cornersConAwayAvg;
							fixtures.get(i).cornersConAvgB=teams.get(j).stats.cornersConAvg;
							
							fixtures.get(i).shotsConAwayAvg=teams.get(j).stats.shotsConAwayAvg;
							fixtures.get(i).shotsConAvgB=teams.get(j).stats.shotsConAvg;
							
							fixtures.get(i).shotsOnTargetConAwayAvg=teams.get(j).stats.shotsOnTargetConAwayAvg;
							fixtures.get(i).shotsOnTargetConAvgB=teams.get(j).stats.shotsOnTargetConAvg;
							
							fixtures.get(i).foulsConAwayAvg=teams.get(j).stats.foulsConAwayAvg;
							fixtures.get(i).foulsConAvgB=teams.get(j).stats.foulsConAvg;
							
							fixtures.get(i).yellowsConAwayAvg=teams.get(j).stats.yellowsConAwayAvg;
							fixtures.get(i).yellowsConAvgB=teams.get(j).stats.yellowsConAvg;
							
							fixtures.get(i).redsConAwayAvg=teams.get(j).stats.redsConAwayAvg;
							fixtures.get(i).redsConAvgB=teams.get(j).stats.redsConAvg;
							
							fixtures.get(i).form3PointsAway=teams.get(j).stats.form3PointsAway;
							fixtures.get(i).form5PointsB=teams.get(j).stats.form5Points;
							
							fixtures.get(i).form3GoalsScoAway=teams.get(j).stats.form3GoalsScoAway;
							fixtures.get(i).form5GoalsScoB=teams.get(j).stats.form5GoalsSco;
							
							fixtures.get(i).form3GoalsConAway=teams.get(j).stats.form3GoalsConAway;
							fixtures.get(i).form5GoalsConB=teams.get(j).stats.form5GoalsCon;
							
							fixtures.get(i).form3BttsAway=teams.get(j).stats.form3BttsAway;
							fixtures.get(i).form5BttsB=teams.get(j).stats.form5Btts;
							
							fixtures.get(i).form3OverAway=teams.get(j).stats.form3OverAway;
							fixtures.get(i).form5OverB=teams.get(j).stats.form5Over;
							
							fixtures.get(i).matchesFormAway=teams.get(j).stats.matchesFormAway;
							fixtures.get(i).matchesFormB=teams.get(j).stats.matchesForm;
				...
				for (int i = 0; i < fixtures.size(); i++) {
					fixtures.get(i).shotRating();
					tempBet="nobet";
					tempOdds=""+fixtures.get(i).HODDS;
					//filter
					
					
					
					if(fixtures.get(i).HODDS>=2.2 &&
							
							
							
							((fixtures.get(i).wonHomePer+fixtures.get(i).wonPerA)/2
							-(fixtures.get(i).wonAwayPer+fixtures.get(i).wonPerB)/2)>=-10 &&
							
							(fixtures.get(i).form3PointsHome>=5) &&
							(fixtures.get(i).form5PointsA>=8) &&
							(fixtures.get(i).form3PointsAway<=4) &&
							(fixtures.get(i).form5PointsB<=6) &&
							(fixtures.get(i).form5PointsA-fixtures.get(i).form5PointsB)>=3
							
						)tempBet="1x";
					
if(fixtures.get(i).AODDS>=2.2&&
							...
							(fixtures.get(i).form3PointsHome<=4) &&
							(fixtures.get(i).form5PointsA<=6) &&
							(fixtures.get(i).form3PointsAway>=5) &&
							(fixtures.get(i).form5PointsB>=8) &&
							(fixtures.get(i).form5PointsA-fixtures.get(i).form5PointsB)<=-3
					...
					if(fixtures.get(i).HODDS>=1.35 &&
							((fixtures.get(i).wonHomePer+fixtures.get(i).wonPerA)/2
							-(fixtures.get(i).wonAwayPer+fixtures.get(i).wonPerB)/2)>=30 &&
							
							(fixtures.get(i).form3PointsHome>=4) &&
							(fixtures.get(i).form5PointsA>=7) &&
							(fixtures.get(i).form3PointsAway<=5) &&
							(fixtures.get(i).form5PointsB<=8) &&
							
							(((fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2.0)-
							((fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)/2)>0.5
									||
							(fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2.0>=1.25 &&
							(fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)/2<=1)
							&&
							(((fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2.0)-
							((fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2)<-0.5
							||
							(fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2.0<=1 &&
							(fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2>=1.25))
						{
						if(tempBet.equals("1x")) System.out.println("lol "+fixtures.get(i).homeTeam);
						tempBet="1";
						}
						
					if(fixtures.get(i).AODDS>=1.35 &&
							((fixtures.get(i).wonHomePer+fixtures.get(i).wonPerA)/2
							-(fixtures.get(i).wonAwayPer+fixtures.get(i).wonPerB)/2)<=-30 &&
							...
							(fixtures.get(i).form5PointsA<=8) &&
							(fixtures.get(i).form3PointsAway>=4) &&
							(fixtures.get(i).form5PointsB>=7) &&
					
							(((fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2.0)-
							((fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)/2)<-0.5
									||
							(fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2.0<=1 &&
							(fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)/2>=1.25)
								&&
							
								(((fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2.0)-
							((fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2)>0.5
							||
							(fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2.0>=1.25 &&
							(fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2<=1)){
						if(tempBet.equals("2x")) System.out.println("lol "+fixtures.get(i).homeTeam);
						tempBet="2";
						}
			
					
					if(		((fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2.0)+
							((fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)/2.0)>2.3 &&
							
							((fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2.0)+
							((fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2.0)>=1.8 &&
							
							(fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2.0>=1 &&
							(fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)/2.0>=1 &&
					
							(fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2.0>=0.8 &&
							(fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2.0>=0.8 &&
							
							(fixtures.get(i).bttsHomePer+fixtures.get(i).bttsPerA)/2.0>=45 &&
							(fixtures.get(i).bttsAwayPer+fixtures.get(i).bttsPerB)/2.0>=45 &&
							
							(fixtures.get(i).overHomePer+fixtures.get(i).overPerA)/2.0>=50 &&
							(fixtures.get(i).overAwayPer+fixtures.get(i).overPerB)/2.0>=50
							
							&&(fixtures.get(i).form3BttsHome)>=1 &&
									(fixtures.get(i).form5BttsA)>=2 &&
							(fixtures.get(i).form3BttsAway)>=1 &&
									(fixtures.get(i).form5BttsB)>=2 &&
							
							(fixtures.get(i).form3OverHome)>=1 &&
							(fixtures.get(i).form5OverA)>=2 &&
							(fixtures.get(i).form3OverAway)>=1 &&
							(fixtures.get(i).form5OverB)>=2
							&&
							(fixtures.get(i).form5OverA)+(fixtures.get(i).form5OverB)>=5
							&&
							(fixtures.get(i).form3OverHome)+(fixtures.get(i).form3OverAway)>=3
							
							) {
								if(tempBet.equals("nobet")) {
									tempBet="o";
								}
								else if(tempBet.equals("1")) {
									tempBet="1o";
								}
								else if(tempBet.equals("2")) {
									tempBet="2o";
							}
								else if(tempBet.equals("1x")) {
									tempBet="1xo";
							}
								else if(tempBet.equals("2x")) {
									tempBet="2xo";
							}
					}	
								//under
								double t=4.5;
								if(		(fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)+
										(fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)<4.6 &&
										
										(fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)+
										(fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)<4.6 &&
										
										(fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)<3 &&
										(fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgB)<3 &&
								
										(fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)<3 &&
										(fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)<3 &&
										
										(fixtures.get(i).bttsHomePer+fixtures.get(i).bttsPerA)+
										(fixtures.get(i).bttsAwayPer+fixtures.get(i).bttsPerB)<220
										&&
										(fixtures.get(i).overHomePer+fixtures.get(i).overPerA)+
										(fixtures.get(i).overAwayPer+fixtures.get(i).overPerB)<220
										&&(fixtures.get(i).form3BttsHome)<3 &&
												(fixtures.get(i).form5BttsA)<4 &&
										(fixtures.get(i).form3BttsAway)<3 &&
												(fixtures.get(i).form5BttsB)<4 
										
										 &&
										(fixtures.get(i).form3OverHome)<3 &&
												(fixtures.get(i).form5OverA)<4 &&
										(fixtures.get(i).form3OverAway)<3 &&
												(fixtures.get(i).form5OverB)<4
												&&
												(fixtures.get(i).form5OverA)+(fixtures.get(i).form5OverB)<=5
												&&
												(fixtures.get(i).form3OverHome)+(fixtures.get(i).form3OverAway)<=3 
										) {
//System.out.println(fixtures.get(i).form5BttsA+"-"+fixtures.get(i).form5BttsB+" "+fixtures.get(i).homeTeam+" "+fixtures.get(i).awayTeam);
					...
					if(fixtures.get(i).HODDS>fixtures.get(i).AODDS)	tempOdds=""+fixtures.get(i).AODDS;	
							
							
					if(
							(fixtures.get(i).date).equals(Common.getDate()) &&
							(fixtures.get(i).matchesHome>4 && fixtures.get(i).matchesAway>4)
						&&(!tempBet.equals("nobet"))
						//&&(!true)
					
					//	&& ((tempBet.equals("o"))|| tempBet.equals("1xο") || tempBet.equals("2xο") || tempBet.equals("1ο") || tempBet.equals("2ο"))
					//	&& ((tempBet.equals("u")) || tempBet.equals("1xu") || tempBet.equals("2xu") || tempBet.equals("1u") || tempBet.equals("2u"))
					//	&& (tempBet.equals("1") || tempBet.equals("2") || tempBet.equals("1o") || tempBet.equals("2o") || tempBet.equals("1u") || tempBet.equals("2u"))
					//	&& (tempBet.equals("1x") || tempBet.equals("2x") || tempBet.equals("1xo") || tempBet.equals("2xo") || tempBet.equals("1xu") || tempBet.equals("2xu"))
							
						
						/*
						&&!((fixtures.get(i).form3BttsHome)>=2 &&
						(fixtures.get(i).form5BttsA)>=3 &&
				(fixtures.get(i).form3BttsAway)>=2 &&
						(fixtures.get(i).form5BttsB)>=3 &&
				
				(fixtures.get(i).form3OverHome)>=2 &&
						(fixtures.get(i).form5OverA)>=3 &&
				(fixtures.get(i).form3OverAway)>=2 &&
						(fixtures.get(i).form5OverB)>=3)
						*/
					...
					&&
						...
						*/
						...
						System.out.println("Bet:"+tempBet);
						System.out.println(fixtures.get(i).homeTeam+" "+fixtures.get(i).HODDS+"/"+fixtures.get(i).AODDS+" "+fixtures.get(i).awayTeam+" ");
				/*			
						System.out.println("Home form points:"+fixtures.get(i).form3PointsHome+" / "+fixtures.get(i).form5PointsA+" ");
						System.out.println("Away form points:"+fixtures.get(i).form3PointsAway+" / "+fixtures.get(i).form5PointsB+" ");
						
						System.out.println("Home scores "+Common.df12.format((fixtures.get(i).goalsScoHomeAvg+fixtures.get(i).goalsScoAvgA)/2)+""
											+" away concedes "+
											Common.df12.format((fixtures.get(i).goalsConAwayAvg+fixtures.get(i).goalsConAvgB)/2));
						
						System.out.println("Away scores "+Common.df12.format((fixtures.get(i).goalsScoAwayAvg+fixtures.get(i).goalsScoAvgA)/2)+""
								+" home concedes "+
								Common.df12.format((fixtures.get(i).goalsConHomeAvg+fixtures.get(i).goalsConAvgA)/2));
			
						
						
						System.out.println("Won %:  "+Common.df12.format((fixtures.get(i).wonHomePer+fixtures.get(i).wonPerA)/2)+""
								+" VS "+
								Common.df12.format((fixtures.get(i).wonAwayPer+fixtures.get(i).wonPerB)/2));
						
						System.out.println("Btts %: "+Common.df12.format((fixtures.get(i).bttsHomePer+fixtures.get(i).bttsPerA)/2)+""
								+" VS "+
								Common.df12.format((fixtures.get(i).bttsAwayPer+fixtures.get(i).bttsPerB)/2)+"");
						
						System.out.println("Over %: "+Common.df12.format((fixtures.get(i).overHomePer+fixtures.get(i).overPerA)/2)+""
								+" VS "+
								Common.df12.format((fixtures.get(i).overAwayPer+fixtures.get(i).overPerB)/2)+"");
					*/
						/*
						System.out.println(Common.df12.format(fixtures.get(i).shotsWonHomeAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsWonHomeAvg-fixtures.get(i).shotsWonAvgA)
								+" -> "+
								Common.df12.format(fixtures.get(i).shotsConAwayAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsConAwayAvg-fixtures.get(i).shotsConAvgB)
								+"->shotsHome");
						
						System.out.println(Common.df12.format(fixtures.get(i).shotsOnTargetWonHomeAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsOnTargetWonHomeAvg-fixtures.get(i).shotsOnTargetWonAvgA)
								+" -> "+
								Common.df12.format(fixtures.get(i).shotsOnTargetConAwayAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsOnTargetConAwayAvg-fixtures.get(i).shotsOnTargetConAvgB)
								+"->shotsOnTargetHome");
						
						
						System.out.println(Common.df12.format(fixtures.get(i).shotsWonAwayAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsWonAwayAvg-fixtures.get(i).shotsWonAvgB)
								+" -> "+
								Common.df12.format(fixtures.get(i).shotsConHomeAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsConHomeAvg-fixtures.get(i).shotsConAvgA)
								+"->shotsAway");
						
						System.out.println(Common.df12.format(fixtures.get(i).shotsOnTargetWonAwayAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsOnTargetWonAwayAvg-fixtures.get(i).shotsOnTargetWonAvgB)
								+" -> "+
								Common.df12.format(fixtures.get(i).shotsOnTargetConHomeAvg)+"/"
								+Common.df12.format(fixtures.get(i).shotsOnTargetConHomeAvg-fixtures.get(i).shotsOnTargetConAvgA)
								+"->shotsOnTargetAway");
						*/
						
						System.out.println("----------------------------");
						archives.add(new Archive(fixtures.get(i).date, fixtures.get(i).homeTeam, fixtures.get(i).awayTeam,
							fixtures.get(i).ratingWin,
							fixtures.get(i).ratingOver,
							fixtures.get(i).ratingBtts,
							fixtures.get(i).ratingCorners,
							tempBet,
							fixtures.get(i).createCsvLine()));
					}
